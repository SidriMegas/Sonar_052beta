-- Performance hot paths for Sonar 0.52
-- Safe to run multiple times thanks to IF NOT EXISTS.
-- Covers the hot queries currently used by home, classement musique, profil,
-- navbar search/random, feedback, playlist, paris and notifications.
...
-- =====================================
-- JEU VUE / PLAYLIST / COFFRE / BOTTLES
-- =====================================
